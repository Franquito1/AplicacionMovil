...
public class ConfiActivity extends AppCompatActivity {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                Refdatabase.child("Users").child(currentUserrID).child("image")
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        {
                                            Toast.makeText(ConfiActivity.this, "Image saved in database successfuly", Toast.LENGTH_SHORT).show();
                                        }
                                        else
                                        {
                                            String message = task.getException().toString();
                                            Toast.makeText(ConfiActivity.this, "Error: " + message,Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
    ...
    private void UpdateSettings() {
        ...
        {
            Toast.makeText(ConfiActivity.this,"Please write your user name first...",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(setuserstatus))
        {
            Toast.makeText(ConfiActivity.this,"Please write your status first...",Toast.LENGTH_SHORT).show();
        }
        else
        {
            ...
            Refdatabase.child("Users").child(currentUserrID).updateChildren(profileMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful())
                    {
                        Toast.makeText(ConfiActivity.this,"Your profile has been updated...",Toast.LENGTH_SHORT).show();
                        sendUserToMainActivity();
                    }
                    else
                    {
                        String errormessage=task.getException().toString();
                        Toast.makeText(ConfiActivity.this,"Error :"+errormessage,Toast.LENGTH_SHORT).show();
                    }
                }
            });
    ...
    private void sendUserToMainActivity() {
        Intent mainIntent=new Intent(ConfiActivity.this,MainActivity.class);
    ...
    private void RetrieveUserInfo() {
        ...
        Refdatabase.child("Users").child(currentUserrID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    Toast.makeText(ConfiActivity.this,"Please set and update your profile information...",Toast.LENGTH_SHORT).show();
                }
            }
